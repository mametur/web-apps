...
// execute middleware
app.use(logger);
app.use(bodyParser.raw({ type: 'text/plain' })); //Body-parser is the Node.js body parsing middleware. It is responsible for parsing the incoming request bodies in a middleware before you handle it.
